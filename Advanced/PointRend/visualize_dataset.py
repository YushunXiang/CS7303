...
cfg.merge_from_file("./configs/pointrend_semantic_R_101_FPN_1x_cityscapes.yaml")
...
for d in random.sample(dataset_dicts, 1):
    ...
    cv2.imwrite("./samples/sample_dataset_input.jpg", img)
    
    print("short_edge_length:", predictor.cfg.INPUT.MIN_SIZE_TEST)
    ...
    # cv2.waitKey(0)
    cv2.imwrite("./samples/sample_dataset_result.jpg", v.get_image()[:, :, ::-1])